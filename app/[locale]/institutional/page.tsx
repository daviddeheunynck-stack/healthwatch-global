...
const COPY: Record<string, {
  ...
  fr: {
    ...
    timeline: [
      ...
      { day: "J+35", event: "Activation de l'abonnement — ou renouvellement pilote si besoin" },
    ],
    ...
    faqs: [
      ...
      { q: "Nous utilisons déjà GPHIN — HealthWatch est-il redondant ?", a: "Non. GPHIN est une infrastructure d'intelligence pour vos analystes centraux. HealthWatch est la couche opérationnelle pour vos équipes terrain : ceux sans credentials GPHIN, qui travaillent en arabe, français ou espagnol, et qui ont besoin d'alertes et de PDFs partageables sans accès aux systèmes gouvernementaux. Les clients GPHIN l'utilisent principalement pour distribuer l'information à leurs partenaires locaux sans partager leurs credentials." },
  ...
  en: {
    ...
    timeline: [
      ...
      { day: "Day 35", event: "Subscription activation — or pilot extension if needed" },
    ],
    ...
    faqs: [
      ...
      { q: "We already use GPHIN — is HealthWatch redundant?", a: "No. GPHIN is intelligence infrastructure for your central analysts. HealthWatch is the operational layer for your field teams: those without GPHIN credentials, working in Arabic, French or Spanish, who need alerts and shareable PDFs without access to government systems. GPHIN clients typically use HealthWatch to distribute information to local partners without sharing their credentials." },
  ...
  es: {
    ...
    timeline: [
      ...
      { day: "Día 35", event: "Activación de la suscripción o extensión del piloto" },
    ],
    ...
    faqs: [
      ...
      { q: "Ya usamos GPHIN — ¿HealthWatch es redundante?", a: "No. GPHIN es infraestructura de inteligencia para sus analistas centrales. HealthWatch es la capa operacional para sus equipos de campo: sin credenciales GPHIN, en 5 idiomas, con alertas y PDF compartibles. Los clientes GPHIN lo usan principalmente para distribuir información a socios locales sin compartir sus credenciales." },
  ...
  ar: {
    ...
    timeline: [
      ...
      { day: "اليوم 35", event: "تفعيل الاشتراك أو تمديد التجربة" },
    ],
    ...
    faqs: [
      ...
      { q: "نحن نستخدم GPHIN بالفعل — هل HealthWatch مكرر؟", a: "لا. GPHIN بنية تحتية استخباراتية لمحلليك المركزيين. HealthWatch هي الطبقة التشغيلية لفرقك الميدانية: بدون بيانات اعتماد GPHIN، بـ 5 لغات، مع تنبيهات وتقارير PDF قابلة للمشاركة. يستخدمه عملاء GPHIN أساساً لتوزيع المعلومات على الشركاء المحليين دون مشاركة بياناتهم." },
  ...
  id: {
    ...
    timeline: [
      ...
      { day: "Hari 35", event: "Aktivasi langganan atau perpanjangan pilot" },
    ],
    ...
    faqs: [
      ...
      { q: "Kami sudah menggunakan GPHIN — apakah HealthWatch redundan?", a: "Tidak. GPHIN adalah infrastruktur intelijen untuk analis pusat Anda. HealthWatch adalah lapisan operasional untuk tim lapangan Anda: tanpa kredensial GPHIN, dalam 5 bahasa, dengan peringatan dan PDF yang dapat dibagikan. Klien GPHIN menggunakannya terutama untuk mendistribusikan informasi kepada mitra lokal tanpa berbagi kredensial mereka." },
