...
const COPY: Record<string, {
  ...
  fr: {
    ...
    timeline: [
      ...
      { day: "J+14", event: "Activation de l'abonnement — ou renouvellement pilote si besoin" },
    ],
  ...
  en: {
    ...
    timeline: [
      ...
      { day: "Day 14", event: "Subscription activation — or pilot extension if needed" },
    ],
  ...
  es: {
    ...
    timeline: [
      ...
      { day: "Día 14", event: "Activación de la suscripción o extensión del piloto" },
    ],
  ...
  ar: {
    ...
    timeline: [
      ...
      { day: "اليوم 14", event: "تفعيل الاشتراك أو تمديد التجربة" },
    ],
  ...
  id: {
    ...
    timeline: [
      ...
      { day: "Hari 14", event: "Aktivasi langganan atau perpanjangan pilot" },
    ],
