...
const PRO_COPY: Record<string, {
  ...
  fr: {
    ...
    note: "14 jours gratuits · carte requise, aucun débit avant la fin de l'essai",
  ...
  en: {
    ...
    note: "14 days free · card required, no charge until it ends",
  ...
  es: {
    ...
    note: "14 días gratis · tarjeta requerida, sin cobro hasta que termine",
  ...
  ar: {
    ...
    note: "14 يوماً مجاناً · البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    note: "14 hari gratis · kartu diperlukan, tidak ada tagihan sebelum berakhir",
