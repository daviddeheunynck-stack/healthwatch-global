...
const LABELS: Record<Locale, {
  ...
  fr: {
    ...
    subtitle: `${DISEASE_COUNT} pathogènes suivis en continu via les données officielles de l'OMS, l'ECDC, le PAHO et Africa CDC.`,
    ...
    metaDesc: `Index des ${DISEASE_COUNT} pathogènes suivis en continu par HealthWatch Global — Ebola, Mpox, Choléra, Dengue et bien d'autres. Données officielles OMS, ECDC, PAHO et Africa CDC.`,
    back: "← Accueil",
  ...
  en: {
    ...
    subtitle: `${DISEASE_COUNT} pathogens monitored continuously via official WHO, ECDC, PAHO and Africa CDC data.`,
    ...
    metaDesc: `Index of ${DISEASE_COUNT} pathogens monitored continuously by HealthWatch Global — Ebola, Mpox, Cholera, Dengue and more. Official WHO, ECDC, PAHO and Africa CDC data.`,
    back: "← Home",
  ...
  es: {
    ...
    subtitle: `${DISEASE_COUNT} patógenos monitoreados continuamente mediante datos oficiales de OMS, ECDC, PAHO y Africa CDC.`,
    ...
    metaDesc: `Índice de ${DISEASE_COUNT} patógenos monitoreados continuamente por HealthWatch Global — Ébola, Mpox, Cólera, Dengue y más. Datos oficiales OMS, ECDC, PAHO y Africa CDC.`,
    back: "← Inicio",
  ...
  ar: {
    ...
    subtitle: `${DISEASE_COUNT} مسبباً مرضياً مُراقَباً بشكل مستمر عبر البيانات الرسمية لمنظمة الصحة العالمية، ECDC، PAHO وAfrica CDC.`,
    active: (n) => n === 1 ? "تفشٍّ نشط واحد" : `${n} تفشيات نشطة`,
    noActive: "لا تفشيات نشطة",
    cases: "حالة",
    metaTitle: "الأمراض المعدية المُراقَبة — HealthWatch Global",
    metaDesc: `فهرس ${DISEASE_COUNT} مسبباً مرضياً مُراقَباً بشكل مستمر بواسطة HealthWatch Global — إيبولا، جدري القرود، كوليرا، حمى الضنك والمزيد. بيانات رسمية من منظمة الصحة العالمية، ECDC، PAHO وAfrica CDC.`,
    back: "→ الرئيسية",
  ...
  id: {
    ...
    subtitle: `${DISEASE_COUNT} patogen dipantau secara berkelanjutan menggunakan data resmi WHO, ECDC, PAHO, dan Africa CDC.`,
    ...
    metaDesc: `Indeks ${DISEASE_COUNT} patogen yang dipantau secara berkelanjutan oleh HealthWatch Global — Ebola, Mpox, Kolera, Dengue dan lainnya. Data resmi WHO, ECDC, PAHO dan Africa CDC.`,
    back: "← Beranda",
