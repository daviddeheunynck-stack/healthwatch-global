    ...
    <div className="max-w-3xl mx-auto space-y-10">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">•</span>The Pro plan (€29/month or €249/year) is billed monthly or annually via Stripe. A 14-day free trial is available; a payment method is required at signup, but you will not be charged until the trial ends. Prices exclude applicable taxes.</li>
