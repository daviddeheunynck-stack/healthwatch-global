      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            ...
            publicly available epidemic alert data from sources including the WHO, CDC, ECDC, and ProMED.
            The platform provides dashboards, alert subscriptions, and PDF reports.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            ...
            <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">•</span>One account per person or organization. Sharing credentials with multiple users is not permitted on Starter; contact us for multi-user Enterprise pricing.</li>
          </ul>
        </section>
