...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    limits: [
      ...
      "The source bulletin itself rarely specifies what that date measures — the week of case confirmation, the estimated transmission period, or simply the bulletin's own publication date. These can diverge meaningfully during a rising outbreak; we display the date as published, without inferring which one it is.",
  ...
  fr: {
    ...
    limits: [
      ...
      "Le bulletin source précise rarement ce que cette date mesure — semaine de confirmation du cas, période de transmission estimée, ou simple date de publication du bulletin. Ces trois repères peuvent diverger sensiblement en phase ascendante d'une épidémie ; nous affichons la date telle que publiée, sans déduire de laquelle il s'agit.",
  ...
  es: {
    ...
    limits: [
      ...
      "El boletín fuente rara vez precisa qué mide esa fecha — la semana de confirmación del caso, el período de transmisión estimado, o simplemente la fecha de publicación del boletín. Estos pueden diferir de forma significativa en la fase ascendente de un brote; mostramos la fecha tal como se publica, sin inferir cuál de ellas es.",
  ...
  ar: {
    ...
    limits: [
      ...
      "نادراً ما توضح النشرة المصدر ما تقيسه هذا التاريخ فعلياً — أسبوع تأكيد الحالة، أو فترة انتقال العدوى المقدَّرة، أو مجرد تاريخ نشر النشرة نفسها. قد تتباين هذه المعايير الثلاثة بشكل ملحوظ في المرحلة التصاعدية للتفشي؛ نعرض التاريخ كما نُشر، دون افتراض أيٍّ منها.",
  ...
  id: {
    ...
    limits: [
      ...
      "Buletin sumber itu sendiri jarang menjelaskan apa yang diukur oleh tanggal tersebut — minggu konfirmasi kasus, perkiraan periode penularan, atau sekadar tanggal penerbitan buletin. Ketiganya dapat berbeda secara signifikan pada fase peningkatan wabah; kami menampilkan tanggal sebagaimana diterbitkan, tanpa menyimpulkan yang mana.",
