...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    pipelineSteps: [
      { title: "Automated sync — every 6 hours", desc: "A scheduled cron job fetches the latest publications from each source API and RSS feed. New outbreaks are ingested within 6 hours of official publication." },
  ...
  fr: {
    ...
    pipelineSteps: [
      { title: "Synchronisation automatique — toutes les 6 heures", desc: "Un job cron planifié récupère les dernières publications de chaque source API et flux RSS. Les nouveaux foyers sont intégrés dans les 6 heures suivant la publication officielle." },
  ...
  es: {
    ...
    pipelineSteps: [
      { title: "Sincronización automática — cada 6 horas", desc: "Un trabajo cron programado obtiene las últimas publicaciones de cada API y feed RSS. Los nuevos brotes se incorporan en 6 horas tras la publicación oficial." },
  ...
  ar: {
    ...
    pipelineSteps: [
      { title: "مزامنة تلقائية — كل 6 ساعات", desc: "يجلب جدول cron آلي أحدث المنشورات من كل مصدر. تُدرج تفشيات جديدة في غضون 6 ساعات من النشر الرسمي." },
  ...
  id: {
    ...
    pipelineSteps: [
      { title: "Sinkronisasi otomatis — setiap 6 jam", desc: "Cron job terjadwal mengambil publikasi terbaru dari setiap sumber API dan RSS feed. Wabah baru masuk dalam 6 jam setelah publikasi resmi." },
