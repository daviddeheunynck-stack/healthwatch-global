...
import { Check, Gift, ArrowRight, Star, Clock, Shield, Mail, Users, Globe, HeartHandshake, Microscope, Stethoscope, Landmark, RefreshCw } from "lucide-react";
  ...
  const pricingSchema = {
    ...
    "offers": [
      ...
      },
      {
        ...
        "description": "All regions, instant alerts, Slack/Teams integration, unlimited CSV export.",
      },
    ],
  };
