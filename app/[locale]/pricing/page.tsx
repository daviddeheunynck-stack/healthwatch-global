...
const COPY: Record<string, {
  ...
  compareTitle: string;
  features: { label: string; free: boolean | string; pro: boolean | string; enterprise: boolean | string }[];
  ...
  en: {
    ...
    features: [
      { label: "Live outbreak map", free: true, pro: true, enterprise: true },
      ...
      { label: "Weekly email digest", free: true, pro: true, enterprise: true },
      { label: "Regional email alerts", free: false, pro: "All regions", enterprise: "All regions" },
      { label: "Real-time alerts (all regions)", free: false, pro: true, enterprise: true },
      { label: "PDF regional reports", free: false, pro: "All regions", enterprise: "All regions" },
      { label: "CSV data export", free: false, pro: true, enterprise: true },
      { label: "Slack / Teams integration", free: false, pro: true, enterprise: true },
      ...
      { label: "Support", free: "Email", pro: "Priority", enterprise: "Dedicated" },
    ],
    ...
    roiText: "WHO declares 15–25 new disease outbreaks every month. A single crisis that reaches your region before your teams are informed can mean weeks of reactive operations, supply chain disruption, and reputational exposure. At $49/month, Pro costs less than one hour of crisis management.",
  },
  fr: {
    ...
    features: [
      { label: "Carte des épidémies en direct", free: true, pro: true, enterprise: true },
      ...
      { label: "Digest email hebdomadaire", free: true, pro: true, enterprise: true },
      { label: "Alertes email régionales", free: false, pro: "Toutes les régions", enterprise: "Toutes les régions" },
      { label: "Alertes en temps réel (toutes régions)", free: false, pro: true, enterprise: true },
      { label: "Rapports PDF régionaux", free: false, pro: "Toutes les régions", enterprise: "Toutes les régions" },
      { label: "Export CSV des données", free: false, pro: true, enterprise: true },
      { label: "Intégration Slack / Teams", free: false, pro: true, enterprise: true },
      { label: "Accès API REST", free: false, pro: false, enterprise: true },
      { label: "Déploiement on-premise", free: false, pro: false, enterprise: true },
      { label: "SLA 99,9 %", free: false, pro: false, enterprise: true },
      { label: "Account manager dédié", free: false, pro: false, enterprise: true },
      { label: "Support", free: "Email", pro: "Prioritaire", enterprise: "Dédié" },
    ],
    ...
    roiText: "L'OMS déclare 15 à 25 nouveaux foyers épidémiques chaque mois. Un seul foyer qui atteint votre région avant que vos équipes soient informées peut signifier des semaines d'opérations réactives, une rupture de la chaîne d'approvisionnement et une exposition médiatique. À 49 €/mois, le plan Pro coûte moins d'une heure de gestion de crise.",
  },
  es: {
    ...
    features: [
      { label: "Mapa de brotes en vivo", free: true, pro: true, enterprise: true },
      ...
      { label: "Digest semanal por email", free: true, pro: true, enterprise: true },
      { label: "Alertas email regionales", free: false, pro: "Todas las regiones", enterprise: "Todas las regiones" },
      { label: "Alertas en tiempo real (todas las regiones)", free: false, pro: true, enterprise: true },
      { label: "Informes PDF regionales", free: false, pro: "Todas las regiones", enterprise: "Todas las regiones" },
      { label: "Exportación de datos CSV", free: false, pro: true, enterprise: true },
      { label: "Integración Slack / Teams", free: false, pro: true, enterprise: true },
      { label: "Acceso API REST", free: false, pro: false, enterprise: true },
      { label: "Implementación on-premise", free: false, pro: false, enterprise: true },
      { label: "SLA del 99,9%", free: false, pro: false, enterprise: true },
      { label: "Gestor de cuenta dedicado", free: false, pro: false, enterprise: true },
      { label: "Soporte", free: "Email", pro: "Prioritario", enterprise: "Dedicado" },
    ],
    ...
    roiText: "La OMS declara entre 15 y 25 nuevos brotes de enfermedades cada mes. Un solo brote que llegue a su región antes de que sus equipos estén informados puede significar semanas de operaciones reactivas y exposición reputacional. A $49/mes, el plan Pro cuesta menos de una hora de gestión de crisis.",
  },
  ar: {
    ...
    features: [
      { label: "خريطة التفشيات المباشرة", free: true, pro: true, enterprise: true },
      ...
      { label: "ملخص بريدي أسبوعي", free: true, pro: true, enterprise: true },
      { label: "تنبيهات بريدية إقليمية", free: false, pro: "جميع المناطق", enterprise: "جميع المناطق" },
      { label: "تنبيهات فورية (جميع المناطق)", free: false, pro: true, enterprise: true },
      { label: "تقارير PDF إقليمية", free: false, pro: "جميع المناطق", enterprise: "جميع المناطق" },
      { label: "تصدير البيانات CSV", free: false, pro: true, enterprise: true },
      { label: "تكامل Slack / Teams", free: false, pro: true, enterprise: true },
      { label: "الوصول لـ REST API", free: false, pro: false, enterprise: true },
      { label: "نشر محلي", free: false, pro: false, enterprise: true },
      { label: "ضمان SLA 99.9%", free: false, pro: false, enterprise: true },
      { label: "مدير حساب مخصص", free: false, pro: false, enterprise: true },
      { label: "الدعم", free: "بريد إلكتروني", pro: "أولوية", enterprise: "مخصص" },
    ],
    ...
    roiText: "تُعلن منظمة الصحة العالمية عن 15 إلى 25 تفشياً جديداً للأمراض كل شهر. تفشٍّ واحد يصل إلى منطقتك قبل إحاطة فريقك قد يعني أسابيع من العمليات التفاعلية والأضرار المؤسسية. بـ 49 دولار/شهر، تكلفة خطة Pro أقل من ساعة واحدة لإدارة الأزمات.",
  },
  id: {
    ...
    features: [
      { label: "Peta wabah langsung", free: true, pro: true, enterprise: true },
      ...
      { label: "Digest email mingguan", free: true, pro: true, enterprise: true },
      { label: "Peringatan email regional", free: false, pro: "Semua wilayah", enterprise: "Semua wilayah" },
      { label: "Peringatan real-time (semua wilayah)", free: false, pro: true, enterprise: true },
      { label: "Laporan PDF regional", free: false, pro: "Semua wilayah", enterprise: "Semua wilayah" },
      { label: "Ekspor data CSV", free: false, pro: true, enterprise: true },
      { label: "Integrasi Slack / Teams", free: false, pro: true, enterprise: true },
      { label: "Akses REST API", free: false, pro: false, enterprise: true },
      { label: "Penerapan on-premise", free: false, pro: false, enterprise: true },
      { label: "SLA 99,9%", free: false, pro: false, enterprise: true },
      { label: "Manajer akun khusus", free: false, pro: false, enterprise: true },
      { label: "Dukungan", free: "Email", pro: "Prioritas", enterprise: "Khusus" },
    ],
    ...
    roiText: "WHO mendeklarasikan 15–25 wabah penyakit baru setiap bulan. Satu wabah yang mencapai wilayah Anda sebelum tim Anda mendapat informasi bisa berarti berminggu-minggu operasi reaktif dan kerusakan reputasi. Dengan $49/bulan, Pro lebih murah dari satu jam manajemen krisis.",
  },
};
