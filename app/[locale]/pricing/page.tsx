...
const COPY: Record<string, {
  ...
  en: {
    ...
    roiText: "WHO declares 15–25 new disease outbreaks every month. A single crisis that reaches your region before your teams are informed can mean weeks of reactive operations, supply chain disruption, and reputational exposure. At $29/month, Starter costs less than one hour of crisis management.",
  },
  fr: {
    ...
    roiText: "L'OMS déclare 15 à 25 nouveaux foyers épidémiques chaque mois. Un seul foyer qui atteint votre région avant que vos équipes soient informées peut signifier des semaines d'opérations réactives, une rupture de la chaîne d'approvisionnement et une exposition médiatique. À 29 €/mois, la formule Starter coûte moins d'une heure de gestion de crise.",
  },
  es: {
    ...
    roiText: "La OMS declara entre 15 y 25 nuevos brotes de enfermedades cada mes. Un solo brote que llegue a su región antes de que sus equipos estén informados puede significar semanas de operaciones reactivas y exposición reputacional. A $29/mes, el plan Starter cuesta menos de una hora de gestión de crisis.",
  },
  ar: {
    ...
    roiText: "تُعلن منظمة الصحة العالمية عن 15 إلى 25 تفشياً جديداً للأمراض كل شهر. تفشٍّ واحد يصل إلى منطقتك قبل إحاطة فريقك قد يعني أسابيع من العمليات التفاعلية والأضرار المؤسسية. بـ 29 دولار/شهر، تكلفة خطة Starter أقل من ساعة واحدة لإدارة الأزمات.",
  },
  id: {
    ...
    roiText: "WHO mendeklarasikan 15–25 wabah penyakit baru setiap bulan. Satu wabah yang mencapai wilayah Anda sebelum tim Anda mendapat informasi bisa berarti berminggu-minggu operasi reaktif dan kerusakan reputasi. Dengan $29/bulan, Starter lebih murah dari satu jam manajemen krisis.",
  },
};
