  ...
  return {
    ...
    alternates: {
      ...
      languages: Object.fromEntries(
        LOCALES.map((l) => [l, `https://healthwatch-global.com/${l}/pricing`])
      ),
    },
    openGraph: {
      type: "website",
...
const COPY: Record<string, {
  ...
  en: {
    ...
    features: [
      ...
      { label: "Instant alerts (all regions)", free: false, pro: true, enterprise: true },
  ...
  fr: {
    ...
    features: [
      ...
      { label: "Alertes instantanées (toutes régions)", free: false, pro: true, enterprise: true },
  ...
  es: {
    ...
    features: [
      ...
      { label: "Alertas instantáneas (todas las regiones)", free: false, pro: true, enterprise: true },
  ...
  id: {
    ...
    features: [
      ...
      { label: "Peringatan instan (semua wilayah)", free: false, pro: true, enterprise: true },
