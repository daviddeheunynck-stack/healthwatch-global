...
const COPY: Record<string, {
  ...
  en: {
    ...
    features: [
      ...
      { label: "Predictive trend alerts", free: false, pro: true, team: true, enterprise: true },
  ...
  fr: {
    ...
    features: [
      ...
      { label: "Alertes de tendance prédictive", free: false, pro: true, team: true, enterprise: true },
  ...
  es: {
    ...
    features: [
      ...
      { label: "Alertas de tendencia predictiva", free: false, pro: true, team: true, enterprise: true },
  ...
  ar: {
    ...
    features: [
      ...
      { label: "تنبيهات الاتجاه التنبؤي", free: false, pro: true, team: true, enterprise: true },
  ...
  id: {
    ...
    features: [
      ...
      { label: "Peringatan tren prediktif", free: false, pro: true, team: true, enterprise: true },
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-red-300 font-semibold text-sm">
              {locale === "fr" ? "Programme pilote institutionnel — 14 jours gratuits" : locale === "es" ? "Programa piloto institucional — 14 días gratis" : locale === "ar" ? "البرنامج التجريبي المؤسسي — 14 يوماً مجاناً" : locale === "id" ? "Program pilot institusional — 14 hari gratis" : "Institutional pilot program — 14 days free"}
            </p>
