...
const LABELS: Record<string, LocaleLabels> = {
  en: {
    ...
    readyItems: ["Region filtering", "Full regional reports (PDF)", "Instant alerts", "All global regions", "Disease-specific alerts (Mpox, Ebola, Cholera...)"],
    cta:          "Go to dashboard →",
  ...
  fr: {
    ...
    readyItems: ["Filtre par région", "Rapports régionaux complets (PDF)", "Alertes instantanées", "Toutes les régions mondiales", "Alertes par maladie (Mpox, Ebola, Choléra...)"],
  ...
  es: {
    ...
    readyItems: ["Filtro por región", "Informes regionales completos (PDF)", "Alertas instantáneas", "Todas las regiones mundiales", "Alertas por enfermedad (Mpox, Ébola, Cólera...)"],
    cta:          "Ir al panel →",
  ...
  ar: {
    ...
    readyItems: ["التصفية حسب المنطقة", "تقارير إقليمية كاملة (PDF)", "تنبيهات فورية", "جميع المناطق العالمية", "تنبيهات خاصة بالأمراض (Mpox، إيبولا، كوليرا...)"],
  ...
  id: {
    ...
    readyItems: ["Filter wilayah", "Laporan regional lengkap (PDF)", "Peringatan instan", "Semua wilayah global", "Peringatan per penyakit (Mpox, Ebola, Kolera...)"],
    cta:          "Buka dasbor →",
