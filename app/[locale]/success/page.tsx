...
const LABELS: Record<string, {
  ...
  en: {
    ...
    readyItems: ["Exact case & death figures", "Full regional reports (PDF)", "Real-time alerts", "All global regions"],
    cta: "Go to dashboard →",
  ...
  fr: {
    ...
    readyItems: ["Chiffres exacts (cas & décès)", "Rapports régionaux complets (PDF)", "Alertes en temps réel", "Toutes les régions mondiales"],
  ...
  es: {
    ...
    readyItems: ["Cifras exactas (casos y fallecimientos)", "Informes regionales completos (PDF)", "Alertas en tiempo real", "Todas las regiones mundiales"],
    cta: "Ir al panel →",
  ...
  id: {
    ...
    readyItems: ["Angka tepat (kasus & kematian)", "Laporan regional lengkap (PDF)", "Peringatan real-time", "Semua wilayah global"],
    cta: "Buka dasbor →",
