...
const LABELS: Record<Locale, {
  ...
  en: {
    ...
    metaDesc: "Monitor disease outbreaks by WHO region. Continuously updated data from WHO, ECDC, PAHO and Africa CDC across Africa, Asia, Americas, Europe, and Oceania.",
    proTitle: "Get daily regional alerts for your areas of operation",
  ...
  fr: {
    ...
    metaDesc: "Surveillance des épidémies par région OMS. Données en continu OMS, ECDC, PAHO et Africa CDC.",
    proTitle: "Alertes régionales quotidiennes pour vos zones d'opération",
  ...
  es: {
    ...
    metaDesc: "Vigilancia de brotes por región OMS. Datos continuamente actualizados de OMS, ECDC, PAHO y Africa CDC.",
    proTitle: "Alertas regionales diarias para sus zonas de operación",
  ...
  ar: {
    ...
    proTitle: "تنبيهات إقليمية يومية لمناطق عملياتك",
  ...
  id: {
    ...
    metaDesc: "Pantau wabah penyakit menurut wilayah WHO. Data yang diperbarui berkelanjutan dari WHO, ECDC, PAHO dan Africa CDC.",
    proTitle: "Peringatan regional harian untuk wilayah operasi Anda",
