...
export const metadata: Metadata = {
  ...
  description: "REST API reference for the HealthWatch Global Enterprise plan. Access real-time outbreak data programmatically.",
};
    ...
    <div className="max-w-4xl mx-auto py-4 space-y-12">
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-400 text-lg leading-relaxed max-w-2xl">
          Programmatic access to real-time WHO outbreak data. Available on the{" "}
