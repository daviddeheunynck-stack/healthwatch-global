...
async function DashboardContent({ demo = false, urlRegion, urlRisk }: { demo?: boolean; urlRegion?: string; urlRisk?: string }) {
  ...
  const tableLabels = {
    ...
    pressBadge:          fc.pressBadge,
    pressTooltip:        fc.pressTooltip,
