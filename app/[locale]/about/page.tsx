...
const LABELS: Record<string, {
  ...
  fr: {
    ...
    howSteps: [
      ...
      { title: "Diffusion", text: "Abonnez-vous à un digest hebdomadaire par email pour recevoir uniquement les alertes de votre région ou du monde entier." },
    ],
    usersTitle: "Pour qui ?",
    users: [
      ...
      { title: "Journalistes & chercheurs", text: "Accédez à des données structurées et sourcées pour vos articles ou travaux de recherche." },
      { title: "ONG & organisations", text: "Surveillez les régions prioritaires et recevez des alertes ciblées pour réagir rapidement." },
    ],
  ...
  en: {
    ...
    howSteps: [
      ...
      { title: "Distribution", text: "Subscribe to a weekly email digest to receive only alerts for your region or worldwide." },
    ],
    ...
    users: [
      ...
      { title: "Journalists & researchers", text: "Access structured, sourced data for your articles or research." },
      { title: "NGOs & organisations", text: "Monitor priority regions and receive targeted alerts to react quickly." },
    ],
  ...
  es: {
    ...
    howSteps: [
      ...
      { title: "Distribución", text: "Suscríbete a un resumen semanal por email para recibir solo las alertas de tu región o de todo el mundo." },
    ],
    ...
    users: [
      ...
      { title: "Periodistas e investigadores", text: "Acceda a datos estructurados y con fuentes para sus artículos o investigaciones." },
      { title: "ONG y organizaciones", text: "Monitoree regiones prioritarias y reciba alertas específicas para reaccionar rápidamente." },
    ],
  ...
  ar: {
    ...
    howSteps: [
      ...
      { title: "التوزيع", text: "اشترك في ملخص أسبوعي عبر البريد الإلكتروني لتلقي تنبيهات منطقتك فقط أو تنبيهات العالم بأسره." },
    ],
    usersTitle: "لمن هو؟",
    users: [
      ...
      { title: "الصحفيون والباحثون", text: "الوصول إلى بيانات منظمة ومُسنَدة لمقالاتك أو أبحاثك." },
      { title: "المنظمات غير الحكومية", text: "راقب المناطق ذات الأولوية واستقبل تنبيهات مستهدفة للاستجابة السريعة." },
    ],
    techTitle: "التقنيات",
  ...
  id: {
    ...
    howSteps: [
      ...
      { title: "Distribusi", text: "Berlangganan digest email mingguan untuk menerima hanya peringatan dari wilayah Anda atau seluruh dunia." },
    ],
    ...
    users: [
      ...
      { title: "Jurnalis & peneliti", text: "Akses data terstruktur dan bersumber untuk artikel atau penelitian Anda." },
      { title: "LSM & organisasi", text: "Pantau wilayah prioritas dan terima peringatan yang ditargetkan untuk bereaksi dengan cepat." },
    ],
    techTitle: "Teknologi",
