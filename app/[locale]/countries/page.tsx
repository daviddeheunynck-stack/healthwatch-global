...
const LABELS: Record<Locale, {
  ...
  en: {
    ...
    proTitle: "Get daily alerts for every country you track",
  ...
  fr: {
    ...
    proTitle: "Alertes quotidiennes pour chaque pays que vous suivez",
  ...
  es: {
    ...
    proTitle: "Alertas diarias para cada país que monitoriza",
  ...
  ar: {
    ...
    proTitle: "تنبيهات يومية لكل دولة تتابعها",
  ...
  id: {
    ...
    proTitle: "Peringatan harian untuk setiap negara yang Anda pantau",
