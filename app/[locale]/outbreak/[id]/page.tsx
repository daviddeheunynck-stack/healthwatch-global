...
const LABELS = {
  fr: {
    ...
    ctaSub: "Essai Pro 7 jours gratuit — carte requise, aucun débit avant la fin de l'essai",
  ...
  en: {
    ...
    ctaSub: "7-day Pro trial — card required, no charge until it ends",
  ...
  es: {
    ...
    ctaSub: "Prueba Pro 7 días gratis — tarjeta requerida, sin cobro hasta que termine",
  ...
  ar: {
    ...
    ctaSub: "تجربة Pro مجانية 7 أيام — البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    ctaSub: "Uji coba Pro 7 hari gratis — kartu diperlukan, tidak ada tagihan sebelum berakhir",
