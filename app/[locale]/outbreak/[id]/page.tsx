...
const LABELS = {
  fr: {
    ...
    ctaSub: "Essai Pro 14 jours gratuit — carte requise, aucun débit avant la fin de l'essai",
  ...
  en: {
    ...
    ctaSub: "14-day Pro trial — card required, no charge until it ends",
  ...
  es: {
    ...
    ctaSub: "Prueba Pro 14 días gratis — tarjeta requerida, sin cobro hasta que termine",
  ...
  ar: {
    ...
    ctaSub: "تجربة Pro مجانية 14 يوماً — البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    ctaSub: "Uji coba Pro 14 hari gratis — kartu diperlukan, tidak ada tagihan sebelum berakhir",
