...
const LABELS: Record<string, Record<string, string>> = {
  fr: {
    ...
    disclaimer: "Ces données proviennent de sources officielles (OMS) et sont fournies à titre informatif uniquement. Elles ne constituent pas un avis médical.",
  ...
  en: {
    ...
    disclaimer: "Data sourced from official organizations (WHO) for informational purposes only. Not medical advice.",
  ...
  es: {
    ...
    disclaimer: "Datos de fuentes oficiales (OMS) solo para información. No es consejo médico.",
  ...
  ar: {
    ...
    disclaimer: "البيانات من مصادر رسمية (OMS) للأغراض الإعلامية فقط. ليست نصيحة طبية.",
  ...
  id: {
    ...
    disclaimer: "Data dari sumber resmi (WHO) hanya untuk informasi. Bukan saran medis.",
