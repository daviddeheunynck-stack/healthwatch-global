...
const COPY: Record<string, {
  ...
  fr: {
    ...
    s2b_title: "Abonnements aux alertes",
    s2b_body: "Email, région préférée et langue. Utilisés pour envoyer le digest sanitaire hebdomadaire demandé.",
    ...
    s4_rows: [
      ...
      ["Brevo", "Emails transactionnels et digest", "UE (Paris)"],
  ...
  es: {
    ...
    s2b_title: "Suscripciones a alertas",
    s2b_body: "Email, región preferida e idioma. Usados para enviarle el digest semanal de salud solicitado.",
    ...
    s4_rows: [
      ...
      ["Brevo", "Emails transaccionales y digest", "UE (París)"],
  ...
  ar: {
    ...
    s2b_title: "اشتراكات التنبيهات",
    s2b_body: "البريد الإلكتروني والمنطقة المفضلة واللغة. تُستخدم لإرسال الملخص الصحي الأسبوعي المطلوب.",
    ...
    s4_rows: [
      ...
      ["Brevo", "رسائل البريد الإلكتروني والملخص", "الاتحاد الأوروبي (باريس)"],
  ...
  id: {
    ...
    s2b_title: "Langganan peringatan",
    s2b_body: "Alamat email, wilayah dan bahasa pilihan. Digunakan untuk mengirimkan digest kesehatan mingguan yang Anda minta.",
    ...
    s4_rows: [
      ...
      ["Brevo", "Email transaksional & digest", "UE (Paris)"],
