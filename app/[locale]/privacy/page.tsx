...
const COPY: Record<string, {
  ...
  es: {
    ...
    s4_rows: [
      ...
      ["ProMED (ISID)", "Fuente de corroboración secundaria (datos públicos)", "Público"],
    ],
  ...
  ar: {
    ...
    s4_rows: [
      ...
      ["ProMED (ISID)", "مصدر التحقق الثانوي (بيانات عامة)", "عام"],
    ],
  ...
  id: {
    ...
    s4_rows: [
      ...
      ["ProMED (ISID)", "Sumber korroborasi sekunder (data publik)", "Publik"],
    ],
