...
const COPY: Record<string, {
  ...
  fr: {
    ...
    s4_rows: [
      ...
      ["WHO · ECDC · PAHO · Africa CDC", "Sources des données épidémiques (données publiques)", "Public"],
    ],
  ...
  en: {
    ...
    s4_rows: [
      ...
      ["WHO · ECDC · PAHO · Africa CDC", "Epidemic data sources (public data)", "Public"],
    ],
  ...
  es: {
    ...
    s4_rows: [
      ...
      ["WHO · ECDC · PAHO · Africa CDC", "Fuentes de datos epidémicos (datos públicos)", "Público"],
    ],
  ...
  ar: {
    ...
    s4_rows: [
      ...
      ["WHO · ECDC · PAHO · Africa CDC", "مصادر البيانات الوبائية (بيانات عامة)", "عام"],
    ],
  ...
  id: {
    ...
    s4_rows: [
      ...
      ["WHO · ECDC · PAHO · Africa CDC", "Sumber data epidemi (data publik)", "Publik"],
    ],
