...
const LABELS: Record<Locale, {
  ...
  fr: {
    ...
    ctaBody: "Soyez alerté dès qu'un nouveau foyer est détecté, ou qu'un foyer existant s'aggrave.",
  ...
  en: {
    ...
    ctaBody: "Be notified the moment a new outbreak is detected, or an existing one escalates.",
  ...
  es: {
    ...
    ctaBody: "Sé notificado en cuanto se detecte un nuevo brote, o si un brote existente se agrava.",
  ...
  ar: {
    ...
    ctaBody: "احصل على إشعار فور اكتشاف تفشٍّ جديد، أو تفاقم تفشٍّ قائم.",
  ...
  id: {
    ...
    ctaBody: "Dapatkan notifikasi segera setelah wabah baru terdeteksi, atau saat wabah yang ada memburuk.",
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title: TITLE[l], description: DESC[l], url: canonical, siteName: "HealthWatch Global", type: "website", locale: ({ en: "en_US", fr: "fr_FR", es: "es_ES", ar: "ar_SA", id: "id_ID" } as Record<string, string>)[l] ?? "en_US" },
