...
const COPY = {
  en: {
    ...
    sub: "We offer a free 14-day Pro access for up to 5 members of your organization. No credit card. No sales pitch. In exchange, we ask for honest feedback from people who work in the field.",
    forTitle: "Built for",
    forItems: [
    ...
    askItems: [
      "Two brief check-ins during the 14 days",
    ...
    successDescActivated: "Check your email and click the confirmation link to activate your 14-day Pro access.",
  ...
  fr: {
    ...
    sub: "Nous offrons un accès Pro gratuit de 14 jours pour jusqu'à 5 membres de votre organisation. Sans carte bancaire. Sans démarche commerciale. En échange, nous demandons un retour honnête de personnes qui travaillent sur le terrain.",
    forTitle: "Conçu pour",
    forItems: [
    ...
    askItems: [
      "Deux points rapides pendant les 14 jours",
    ...
    successDescActivated: "Vérifiez votre email et cliquez sur le lien de confirmation pour activer votre accès Pro de 14 jours.",
  ...
  es: {
    ...
    sub: "Ofrecemos acceso Pro gratuito de 14 días para hasta 5 miembros de su organización. Sin tarjeta de crédito. Sin presión comercial. A cambio, pedimos comentarios honestos de personas que trabajan sobre el terreno.",
    ...
    askItems: [
      "Dos breves puntos de control durante los 14 días",
    ...
    successDescActivated: "Revise su correo y haga clic en el enlace de confirmación para activar su acceso Pro de 14 días.",
  ...
  ar: {
    ...
    sub: "نقدم وصولاً مجانياً لخطة Pro لمدة 14 يوماً لما يصل إلى 5 أعضاء في مؤسستك. بدون بطاقة بنكية. بدون ضغوط تجارية. في المقابل، نطلب ملاحظات صادقة من أشخاص يعملون في الميدان.",
    forTitle: "مصمم لـ",
    forItems: [
    ...
    askItems: [
      "متابعتان موجزتان خلال الـ 14 يوماً",
    ...
    successDescActivated: "راجع بريدك الإلكتروني واضغط على رابط التأكيد لتفعيل وصول Pro لمدة 14 يوماً.",
  ...
  id: {
    ...
    sub: "Kami menawarkan akses Pro gratis selama 14 hari untuk hingga 5 anggota organisasi Anda. Tanpa kartu kredit. Tanpa tekanan penjualan. Sebagai gantinya, kami meminta umpan balik jujur dari orang-orang yang bekerja di lapangan.",
    ...
    askItems: [
      "Dua check-in singkat selama 14 hari",
    ...
    successDescActivated: "Cek email Anda dan klik tautan konfirmasi untuk mengaktifkan akses Pro 14 hari Anda.",
...
const FAQ_COPY: Record<string, { title: string; items: { q: string; a: string }[] }> = {
  en: {
    ...
    items: [
      ...
      { q: "What happens at the end of the 14 days?", a: "Accounts automatically revert to the Free plan. No charge, no credit card required. If your team wants to continue with Pro, we'll discuss options at the closing feedback session." },
  ...
  fr: {
    ...
    items: [
      ...
      { q: "Que se passe-t-il à la fin des 14 jours ?", a: "Les comptes passent automatiquement au plan Gratuit. Aucun frais, aucune carte bancaire requise. Si votre équipe souhaite continuer avec Pro, nous en discutons lors de la session de feedback de clôture." },
  ...
  es: {
    ...
    items: [
      ...
      { q: "¿Qué sucede al final de los 14 días?", a: "Las cuentas vuelven automáticamente al plan Gratuito. Sin cargos, sin tarjeta de crédito requerida. Si su equipo desea continuar con Pro, lo discutiremos en la sesión de feedback de cierre." },
  ...
  ar: {
    ...
    items: [
      ...
      { q: "ماذا يحدث في نهاية الـ 14 يوماً؟", a: "تعود الحسابات تلقائياً إلى الخطة المجانية. لا رسوم، لا بطاقة بنكية مطلوبة. إذا أراد فريقك الاستمرار مع Pro، نناقش ذلك في جلسة التغذية الراجعة الختامية." },
  ...
  id: {
    ...
    items: [
      ...
      { q: "Apa yang terjadi setelah 14 hari?", a: "Akun secara otomatis kembali ke paket Gratis. Tidak ada biaya, tidak perlu kartu kredit. Jika tim Anda ingin melanjutkan dengan Pro, kami akan membahasnya di sesi umpan balik penutup." },
    ...
    <div className={`max-w-4xl mx-auto space-y-16${isRtl ? " text-right" : ""}`} dir={isRtl ? "rtl" : "ltr"}>
      ...
      <div className="flex flex-wrap justify-center gap-6 border-y border-gray-800/60 py-5">
        {[
          ...
          { label: locale === "fr" ? "Mise à jour toutes les heures" : locale === "es" ? "Actualización cada hora" : locale === "ar" ? "تحديث كل ساعة" : locale === "id" ? "Diperbarui setiap jam" : "Updated every hour" },
        ].map(({ label }) => (
