...
const DISEASE_MAP: Array<{ patterns: string[]; info: DiseaseInfo }> = [
  {
    ...
    info: {
      ...
      cfr_ref_en: "0.1–10% (by clade)",
      cfr_ref_es: "0.1–10 % (según el clado)",
      r0_ref: "1.1–2.4",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% if treated; 25–50% untreated",
      cfr_ref_es: "< 1 % con tratamiento; 25–50 % sin tratamiento",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% with adequate rehydration; historically a leading cause of infant mortality where access to care is limited",
      cfr_ref_es: "< 1 % con rehidratación adecuada; históricamente una causa importante de mortalidad infantil donde el acceso a la atención es limitado",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "~60% (human H5N1)",
      cfr_ref_es: "~60 % (H5N1 humano)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 0.1% (seasonal)",
      cfr_ref_es: "< 0,1 % (estacional)",
      r0_ref: "1.2–1.4",
      vaccine: "yes",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "Variable by variant",
      cfr_ref_es: "Variable según la variante",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (managed); severe dengue: 2–5%",
      cfr_ref_es: "< 1 % (con atención médica); dengue grave: 2–5 %",
      r0_ref: "2–6",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "3–7.5% (toxic phase: 20–50%)",
      cfr_ref_es: "3–7,5 % (fase tóxica: 20–50 %)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "~1% overall; 15% among hospitalized cases",
      cfr_ref_es: "~1 % global; 15 % en casos hospitalizados",
      vaccine: "no",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "5–15% (meningococcal)",
      cfr_ref_es: "5–15 % (meningocócica)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "30–100% (untreated)",
      cfr_ref_es: "30–100 % (sin tratamiento)",
      vaccine: "no",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% if treated; 10–30% untreated",
      cfr_ref_es: "< 1 % con tratamiento; 10–30 % sin tratamiento",
      vaccine: "yes",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "0.1% (high-income countries) → 1–5% (low-income countries)",
      cfr_ref_es: "0,1 % (países de ingresos altos) → 1–5 % (países de ingresos bajos)",
      r0_ref: "12–18",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (paralytic: 2–5%)",
      cfr_ref_es: "< 1 % (paralítica: 2–5 %)",
      r0_ref: "5–7",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% if treated; severe P. falciparum: 15–20%",
      cfr_ref_es: "< 1 % con tratamiento; P. falciparum grave: 15–20 %",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "~100% (once symptoms appear)",
      cfr_ref_es: "~100 % (tras la aparición de síntomas)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "Cutaneous < 1%; inhalational ~80% (untreated)",
      cfr_ref_es: "Cutáneo < 1 %; por inhalación ~80 % (sin tratamiento)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 0.1% (major teratogenic risk in pregnancy)",
      cfr_ref_es: "< 0,1 % (riesgo teratogénico importante en el embarazo)",
      r0_ref: "1.4–6.6",
      vaccine: "no",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "Variable by type (HEV in pregnancy: 20–25%)",
      cfr_ref_es: "Variable según el tipo (VHE en el embarazo: 20–25 %)",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "~1% overall; haemorrhagic forms: 10–12%",
      cfr_ref_es: "~1 % global; formas hemorrágicas: 10–12 %",
      vaccine: "experimental",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (MDR strains: higher)",
      cfr_ref_es: "< 1 % (cepas multirresistentes: más alta)",
      vaccine: "no",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      travelerRisk: { africa: "moderate", asia: "moderate", americas: "low", oceania: "low", europe: "low" },
    },
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% in adults; infants under 1 year: 1–4%",
      cfr_ref_es: "< 1 % en adultos; lactantes menores de 1 año: 1–4 %",
      r0_ref: "5.5–17",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "Visceral: 95% if untreated; cutaneous: low",
      cfr_ref_es: "Visceral: 95 % si no se trata; cutánea: baja",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "Nearly 100% (untreated HAT)",
      cfr_ref_es: "Casi 100 % (TAH sin tratamiento)",
      vaccine: "no",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (vertical transmission documented in 2024)",
      cfr_ref_es: "< 1 % (transmisión vertical documentada en 2024)",
      vaccine: "no",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (neuroinvasive: 3–15%)",
      cfr_ref_es: "< 1 % (neuroinvasiva: 3–15 %)",
      vaccine: "no",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "~10% (neuroinvasive)",
      cfr_ref_es: "~10 % (neuroinvasiva)",
      vaccine: "no",
      treatment: "supportive",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "< 1% (mild forms); 10–15% (Weil's disease, treated); up to 25–30% with delayed treatment",
      cfr_ref_es: "< 1 % (formas leves); 10–15 % (enfermedad de Weil, tratada); hasta 25–30 % si el tratamiento es tardío",
      vaccine: "no",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "5–10% (treated); 20–30% (untreated); up to 40–50% if treatment starts after day 8–9",
      cfr_ref_es: "5–10 % (tratada); 20–30 % (sin tratar); hasta 40–50 % si el tratamiento comienza después del día 8–9",
      vaccine: "no",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "6% (median, untreated; up to 30–70% in severe forms); < 1.5% if treated with doxycycline",
      cfr_ref_es: "6 % (mediana, sin tratar; hasta 30–70 % en formas graves); < 1,5 % con tratamiento con doxiciclina",
      vaccine: "no",
      treatment: "yes",
  ...
  },
  {
    ...
    info: {
      ...
      cfr_ref_en: "20–30% (among symptomatic encephalitis cases)",
      cfr_ref_es: "20–30 % (entre los casos de encefalitis sintomática)",
