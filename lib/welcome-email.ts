const CONTENT: Record<string, {
  ...
  fr: {
    ...
    feature2Body: "Données agrégées de l'OMS, l'ECDC, l'OPAS et l'Africa CDC — mises à jour toutes les 6 heures.",
  ...
  en: {
    ...
    feature2Body: "Data aggregated from WHO, ECDC, PAHO and Africa CDC — updated every 6 hours.",
  ...
  es: {
    ...
    feature2Body: "Datos agregados de la OMS, ECDC, PAHO y Africa CDC — actualizados cada 6 horas.",
  ...
  ar: {
    ...
    feature2Body: "بيانات مجمّعة من WHO وECDC وPAHO وAfrica CDC — تُحدَّث كل 6 ساعات.",
  ...
  id: {
    ...
    feature2Body: "Data diagregasi dari WHO, ECDC, PAHO dan Africa CDC — diperbarui setiap 6 jam.",
