const CONTENT: Record<string, {
  ...
  fr: {
    ...
    feature1Body: "Visualisez les foyers actifs sur une carte mise à jour quotidiennement, filtrés par région et niveau de risque.",
    ...
    upgrade: "✅ Votre essai Pro de 14 jours s'active automatiquement dès que vous confirmez votre email. Chiffres exacts, alertes régionales, export CSV et rapports PDF — tout inclus.",
  ...
  en: {
    ...
    feature1Body: "Visualise active outbreaks on a daily-updated map, filtered by region and risk level.",
    ...
    cta: "Go to dashboard →",
    upgrade: "✅ Your 14-day Pro trial activates automatically when you confirm your email. Exact figures, regional alerts, CSV export and PDF reports — all included.",
  ...
  es: {
    ...
    feature1Body: "Visualice brotes activos en un mapa actualizado a diario, filtrados por región y nivel de riesgo.",
    ...
    cta: "Ir al panel →",
    upgrade: "✅ Su prueba Pro de 14 días se activa automáticamente al confirmar su email. Cifras exactas, alertas regionales, exportación CSV e informes PDF — todo incluido.",
  ...
  ar: {
    ...
    feature1Body: "تصور تفشيات الأمراض النشطة على خريطة محدّثة يومياً، مصفّاة حسب المنطقة ومستوى الخطر.",
    ...
    upgrade: "✅ تجربتك المجانية Pro لمدة 14 يوماً تُفعَّل تلقائياً عند تأكيد بريدك الإلكتروني. أرقام دقيقة، تنبيهات إقليمية، تصدير CSV وتقارير PDF — كل شيء مشمول.",
  ...
  id: {
    ...
    feature1Body: "Visualisasikan wabah aktif di peta yang diperbarui harian, difilter berdasarkan wilayah dan tingkat risiko.",
    ...
    cta: "Buka dasbor →",
    upgrade: "✅ Uji coba Pro 14 hari Anda aktif otomatis saat Anda mengkonfirmasi email. Angka tepat, peringatan regional, ekspor CSV dan laporan PDF — semua termasuk.",
