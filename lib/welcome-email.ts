const CONTENT: Record<string, {
  ...
  fr: {
    ...
    upgrade: "Passez à Starter ou Pro pour débloquer les chiffres exacts, les exports PDF et les alertes email.",
  ...
  en: {
    ...
    cta: "Go to dashboard →",
    upgrade: "Upgrade to Starter or Pro to unlock exact figures, PDF exports and email alerts.",
  ...
  es: {
    ...
    cta: "Ir al panel →",
    upgrade: "Actualice a Starter o Pro para desbloquear cifras exactas, exportaciones PDF y alertas por email.",
  ...
  ar: {
    ...
    upgrade: "انتقل إلى Starter أو Pro للوصول إلى الأرقام الدقيقة وتصدير PDF والتنبيهات.",
  ...
  id: {
    ...
    cta: "Buka dasbor →",
    upgrade: "Upgrade ke Starter atau Pro untuk membuka angka tepat, ekspor PDF, dan peringatan email.",
