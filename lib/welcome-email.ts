const CONTENT: Record<string, {
  ...
  fr: {
    ...
    upgrade: "✅ Votre essai Pro de 7 jours est déjà actif. Chiffres exacts, alertes régionales, export CSV et rapports PDF — tout inclus pendant 7 jours.",
  ...
  en: {
    ...
    upgrade: "✅ Your 7-day Pro trial is already active. Exact figures, regional alerts, CSV export and PDF reports — all included for 7 days.",
  ...
  es: {
    ...
    upgrade: "✅ Su prueba Pro de 7 días ya está activa. Cifras exactas, alertas regionales, exportación CSV e informes PDF — todo incluido durante 7 días.",
  ...
  ar: {
    ...
    upgrade: "✅ تجربتك المجانية Pro لمدة 7 أيام نشطة الآن. أرقام دقيقة، تنبيهات إقليمية، تصدير CSV وتقارير PDF — كل شيء مشمول لمدة 7 أيام.",
  ...
  id: {
    ...
    upgrade: "✅ Uji coba Pro 7 hari Anda sudah aktif. Angka tepat, peringatan regional, ekspor CSV dan laporan PDF — semua termasuk selama 7 hari.",
