const CONTENT: Record<string, {
  ...
  fr: {
    ...
    greeting: "Bienvenue,",
    intro: "Votre compte HealthWatch Global est créé. Vous avez maintenant accès à la surveillance épidémique mondiale en temps réel.",
    feature1Title: "🗺️ Carte mondiale interactive",
    feature1Body: "Visualisez les foyers actifs sur une carte en temps réel, filtrés par région et niveau de risque.",
    feature2Title: "📊 Tableau de bord actualisé quotidiennement",
    feature2Body: "Données directement issues de l'OMS — mises à jour chaque nuit via l'API officielle Disease Outbreak News.",
    ...
    upgrade: "Passez à Starter ou Pro pour débloquer les chiffres exacts, les alertes email régionales, l'export CSV et les rapports PDF.",
    upgradeLink: "Voir les formules →",
  ...
  en: {
    ...
    greeting: "Welcome,",
    intro: "Your HealthWatch Global account is ready. You now have access to real-time global epidemic surveillance.",
    feature1Title: "🗺️ Interactive world map",
    feature1Body: "Visualise active outbreaks on a real-time map, filtered by region and risk level.",
    feature2Title: "📊 Daily-updated dashboard",
    feature2Body: "Data sourced directly from WHO — updated nightly via the official Disease Outbreak News API.",
    ...
    cta: "Go to dashboard →",
    upgrade: "Upgrade to Starter or Pro to unlock exact figures, regional email alerts, CSV export and PDF reports.",
  ...
  es: {
    ...
    greeting: "Bienvenido,",
    intro: "Su cuenta de HealthWatch Global está lista. Ahora tiene acceso a la vigilancia epidémica mundial en tiempo real.",
    feature1Title: "🗺️ Mapa mundial interactivo",
    feature1Body: "Visualice brotes activos en un mapa en tiempo real, filtrados por región y nivel de riesgo.",
    feature2Title: "📊 Panel actualizado diariamente",
    feature2Body: "Datos directamente de la OMS — actualizados cada noche a través de la API oficial Disease Outbreak News.",
    ...
    cta: "Ir al panel →",
    upgrade: "Actualice a Starter o Pro para desbloquear cifras exactas, alertas email regionales, exportación CSV e informes PDF.",
  ...
  ar: {
    ...
    intro: "حسابك في HealthWatch Global جاهز. يمكنك الآن الوصول إلى مراقبة الأوبئة العالمية في الوقت الفعلي.",
    feature1Title: "🗺️ خريطة العالم التفاعلية",
    feature1Body: "تصور تفشيات الأمراض النشطة على خريطة في الوقت الفعلي، مصفّاة حسب المنطقة ومستوى الخطر.",
    feature2Title: "📊 لوحة تحكم محدّثة يومياً",
    feature2Body: "بيانات مباشرة من منظمة الصحة العالمية — تُحدَّث كل ليلة عبر واجهة برمجة أخبار تفشي الأمراض الرسمية.",
    feature3Title: "📧 ملخص أسبوعي",
    feature3Body: "استلم كل اثنين ملخصاً وبائياً مخصصاً وفق منطقة اهتمامك.",
    cta: "← الذهاب إلى لوحة التحكم",
    upgrade: "انتقل إلى Starter أو Pro للوصول إلى الأرقام الدقيقة والتنبيهات الإقليمية وتصدير CSV وتقارير PDF.",
    upgradeLink: "← عرض الخطط",
    closing: "مع السلامة،",
  ...
  id: {
    ...
    intro: "Akun HealthWatch Global Anda siap. Anda sekarang memiliki akses ke pemantauan epidemi global secara real-time.",
    feature1Title: "🗺️ Peta dunia interaktif",
    feature1Body: "Visualisasikan wabah aktif di peta real-time, difilter berdasarkan wilayah dan tingkat risiko.",
    feature2Title: "📊 Dasbor diperbarui setiap hari",
    feature2Body: "Data langsung dari WHO — diperbarui setiap malam melalui API Disease Outbreak News resmi.",
    ...
    cta: "Buka dasbor →",
    upgrade: "Upgrade ke Starter atau Pro untuk membuka angka tepat, peringatan email regional, ekspor CSV, dan laporan PDF.",
    upgradeLink: "Lihat paket →",
