const CONTENT: Record<string, {
  ...
  fr: {
    ...
    upgrade: "Passez à Pro pour débloquer les chiffres exacts, les alertes email régionales, l'export CSV et les rapports PDF.",
  ...
  en: {
    ...
    cta: "Go to dashboard →",
    upgrade: "Upgrade to Pro to unlock exact figures, regional email alerts, CSV export and PDF reports.",
  ...
  es: {
    ...
    cta: "Ir al panel →",
    upgrade: "Actualice a Pro para desbloquear cifras exactas, alertas email regionales, exportación CSV e informes PDF.",
  ...
  ar: {
    ...
    upgrade: "انتقل إلى Pro للوصول إلى الأرقام الدقيقة والتنبيهات الإقليمية وتصدير CSV وتقارير PDF.",
  ...
  id: {
    ...
    cta: "Buka dasbor →",
    upgrade: "Upgrade ke Pro untuk membuka angka tepat, peringatan email regional, ekspor CSV, dan laporan PDF.",
