  ...
  pro: {
    fr: {
      ...
      features: [
        ...
        "⚡ Alertes instantanées — dès que notre synchronisation quotidienne détecte un nouveau foyer OMS",
    ...
    es: {
      ...
      features: [
        ...
        "⚡ Alertas instantáneas — en cuanto nuestra sincronización diaria detecta un nuevo brote OMS",
    ...
    ar: {
      ...
      features: [
        ...
        "⚡ تنبيهات فورية — فور رصد مزامنتنا اليومية لتفشٍّ جديد من المنظمة",
    ...
    id: {
      ...
      features: [
        ...
        "⚡ Peringatan instan — begitu sinkronisasi harian kami mendeteksi wabah WHO baru",
