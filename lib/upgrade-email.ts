  ...
  pro: {
    fr: {
      ...
      features: [
        ...
        "⚡ Alertes instantanées — dès que notre synchronisation (toutes les 6h) détecte un nouveau foyer OMS",
    ...
    es: {
      ...
      features: [
        ...
        "⚡ Alertas instantáneas — en cuanto nuestra sincronización (cada 6h) detecta un nuevo brote OMS",
    ...
    ar: {
      ...
      features: [
        ...
        "⚡ تنبيهات فورية — فور رصد مزامنتنا (كل 6 ساعات) لتفشٍّ جديد من المنظمة",
    ...
    id: {
      ...
      features: [
        ...
        "⚡ Peringatan instan — begitu sinkronisasi 6 jam kami mendeteksi wabah WHO baru",
