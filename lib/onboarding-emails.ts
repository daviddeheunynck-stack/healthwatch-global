...
const J3_CONTENT: Record<string, {
  ...
  fr: {
    ...
    features: [
      "📊 <strong>Chiffres exacts</strong> — cas confirmés et décès par foyer, jamais une bande de magnitude",
      ...
      "📈 <strong>Alertes de tendance prédictive</strong> — prévenu avant qu'un seuil soit franchi",
      "📥 <strong>Export CSV</strong> — données courantes et historique complet, bouton « Exporter » en haut du tableau de bord",
  ...
  en: {
    ...
    features: [
      "📊 <strong>Exact figures</strong> — confirmed cases and deaths per outbreak, never a magnitude band",
      ...
      "📈 <strong>Predictive trend alerts</strong> — warned before a threshold is crossed",
      "📥 <strong>CSV export</strong> — current data and full history, 'Export' button at the top of the dashboard",
  ...
  es: {
    ...
    features: [
      "📊 <strong>Cifras exactas</strong> — casos confirmados y fallecidos por brote, nunca una banda de magnitud",
      ...
      "📈 <strong>Alertas de tendencia predictiva</strong> — avisado antes de superar un umbral",
      "📥 <strong>Exportación CSV</strong> — datos actuales e historial completo, botón 'Exportar' en la parte superior del panel",
  ...
  ar: {
    ...
    features: [
      "📊 <strong>الأرقام الدقيقة</strong> — الحالات المؤكدة والوفيات لكل تفشٍّ، لا نطاق حجم تقريبي أبداً",
      ...
      "📈 <strong>تنبيهات الاتجاه التنبؤية</strong> — إشعار قبل تجاوز العتبة",
      "📥 <strong>تصدير CSV</strong> — البيانات الحالية والسجل الكامل، زر 'تصدير' أعلى لوحة التحكم",
  ...
  id: {
    ...
    features: [
      "📊 <strong>Angka tepat</strong> — kasus terkonfirmasi dan kematian per wabah, bukan pita magnitudo",
      ...
      "📈 <strong>Peringatan tren prediktif</strong> — diperingatkan sebelum ambang batas terlampaui",
      "📥 <strong>Ekspor CSV</strong> — data terkini dan riwayat lengkap, tombol 'Ekspor' di bagian atas dasbor",
...
const J12_CONTENT: Record<string, {
  ...
  fr: {
    ...
    loseItems: [
      "📊 Chiffres exacts — cas confirmés et décès (remplacés par une bande de magnitude)",
      "📬 Alertes email régionales — plus de notifications en temps réel",
      "📈 Alertes de tendance prédictive — plus d'avertissement avant un seuil franchi",
      "📄 Rapports PDF régionaux — plus d'exports en 1 clic",
      "📥 Export CSV — plus d'accès aux données brutes ni à l'historique",
  ...
  en: {
    ...
    loseItems: [
      "📊 Exact figures — confirmed cases and deaths (replaced by a magnitude band)",
      "📬 Regional email alerts — no more real-time notifications",
      "📈 Predictive trend alerts — no more warning before a threshold is crossed",
      "📄 Regional PDF reports — no more 1-click exports",
      "📥 CSV export — no more raw data or history access",
  ...
  es: {
    ...
    loseItems: [
      "📊 Cifras exactas — casos confirmados y fallecidos (sustituidos por una banda de magnitud)",
      "📬 Alertas email regionales — sin más notificaciones en tiempo real",
      "📈 Alertas de tendencia predictiva — sin aviso antes de superar un umbral",
      "📄 Informes PDF regionales — sin más exportaciones en 1 clic",
      "📥 Exportación CSV — sin más acceso a datos brutos ni al historial",
  ...
  ar: {
    ...
    loseItems: [
      "📊 الأرقام الدقيقة — الحالات المؤكدة والوفيات (تُستبدل بنطاق حجم تقريبي)",
      "📬 التنبيهات البريدية الإقليمية — لن تصلك إشعارات فورية بعد الآن",
      "📈 تنبيهات الاتجاه التنبؤية — لن يصلك إشعار قبل تجاوز العتبة",
      "📄 تقارير PDF الإقليمية — لن تتمكن من التصدير بنقرة واحدة",
      "📥 تصدير CSV — لن تتمكن من الوصول إلى البيانات الخام أو السجل الكامل",
  ...
  id: {
    ...
    loseItems: [
      "📊 Angka tepat — kasus terkonfirmasi dan kematian (diganti pita magnitudo)",
      "📬 Peringatan email regional — tidak ada lagi notifikasi real-time",
      "📈 Peringatan tren prediktif — tidak ada lagi peringatan sebelum ambang batas terlampaui",
      "📄 Laporan PDF regional — tidak ada lagi ekspor 1 klik",
      "📥 Ekspor CSV — tidak ada lagi akses data mentah atau riwayat",
...
const TRIAL_EXPIRED_CONTENT: Record<string, {
  ...
  fr: {
    ...
    lostItems: [
      "📊 Chiffres exacts de cas et de décès (remplacés par une bande de magnitude)",
      "📬 Alertes email régionales en temps réel",
      "📈 Alertes de tendance prédictive",
      "📄 Rapports PDF régionaux téléchargeables",
      "📥 Export CSV des données brutes et de l'historique",
  ...
  en: {
    ...
    lostItems: [
      "📊 Exact case and death figures (replaced by a magnitude band)",
      "📬 Real-time regional email alerts",
      "📈 Predictive trend alerts",
      "📄 Downloadable regional PDF reports",
      "📥 CSV export of raw data and full history",
  ...
  es: {
    ...
    lostItems: [
      "📊 Cifras exactas de casos y fallecidos (sustituidos por una banda de magnitud)",
      "📬 Alertas email regionales en tiempo real",
      "📈 Alertas de tendencia predictiva",
      "📄 Informes PDF regionales descargables",
      "📥 Exportación CSV de datos brutos e historial completo",
  ...
  ar: {
    ...
    lostItems: [
      "📊 الأرقام الدقيقة للحالات والوفيات (تُستبدل بنطاق حجم تقريبي)",
      "📬 تنبيهات البريد الإلكتروني الإقليمية الفورية",
      "📈 تنبيهات الاتجاه التنبؤية",
      "📄 تقارير PDF الإقليمية القابلة للتحميل",
      "📥 تصدير CSV للبيانات الخام والسجل الكامل",
  ...
  id: {
    ...
    lostItems: [
      "📊 Angka kasus dan kematian yang tepat (diganti pita magnitudo)",
      "📬 Peringatan email regional real-time",
      "📈 Peringatan tren prediktif",
      "📄 Laporan PDF regional yang dapat diunduh",
      "📥 Ekspor CSV data mentah dan riwayat lengkap",
...
export function buildJ3Email(locale: string, userId: string): { subject: string; html: string; unsubUrl: string } {
  ...
  const unsubUrl = `https://healthwatch-global.com/api/unsubscribe-onboarding?id=${encodeURIComponent(userId)}&token=${signUnsubscribeToken(userId)}&locale=${locale}`;
