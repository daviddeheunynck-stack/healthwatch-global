...
const COPY: Record<string, LocaleCopy> = {
  fr: {
    starter: {
      ...
      intro:       (d) => `Votre accès Pro expire le <strong>${d}</strong>. Pour conserver l'accès au filtre par région, aux rapports PDF et aux alertes, ajoutez un moyen de paiement dès maintenant.`,
      highlights:  [
        "Filtre par région",
  ...
  en: {
    starter: {
      ...
      intro:       (d) => `Your Pro access expires on <strong>${d}</strong>. To keep access to region filtering, PDF reports and alerts, add a payment method now.`,
      highlights:  [
        "Region filtering",
  ...
  es: {
    starter: {
      ...
      intro:       (d) => `Su acceso Pro expira el <strong>${d}</strong>. Para conservar el acceso al filtro por región, informes PDF y alertas, añada un método de pago ahora.`,
      highlights:  [
        "Filtro por región",
  ...
  ar: {
    starter: {
      ...
      intro:       (d) => `ينتهي وصولك Pro في <strong>${d}</strong>. للاحتفاظ بالوصول إلى التصفية حسب المنطقة وتقارير PDF والتنبيهات، أضف وسيلة دفع الآن.`,
      highlights:  [
        "التصفية حسب المنطقة",
  ...
  id: {
    starter: {
      ...
      intro:       (d) => `Akses Pro Anda berakhir pada <strong>${d}</strong>. Untuk mempertahankan akses ke filter wilayah, laporan PDF, dan peringatan, tambahkan metode pembayaran sekarang.`,
      highlights:  [
        "Filter wilayah",
