...
const COPY: Record<string, Record<string, ChurnCopy>> = {
  ...
  pro: {
    fr: {
      ...
      losing: [
        ...
        "Export CSV — données courantes et historique complet par foyer",
      ],
    ...
    en: {
      ...
      losing: [
        ...
        "CSV export — current data and full per-outbreak history",
      ],
    ...
    es: {
      ...
      losing: [
        ...
        "Exportación CSV — datos actuales e historial completo por brote",
      ],
    ...
    ar: {
      ...
      losing: [
        "التنبيهات الفورية — مزامنة كل ساعة من WHO وECDC وPAHO وAfrica CDC",
        "تنبيهات الاتجاه التنبؤية",
        "تقارير PDF لجميع المناطق العالمية",
        "تكامل Slack / Teams",
        "الأرقام الدقيقة للحالات والوفيات",
        "تصدير CSV — البيانات الحالية والسجل الكامل لكل تفشٍّ",
      ],
    ...
    id: {
      ...
      losing: [
        ...
        "Ekspor CSV — data terkini dan riwayat lengkap per wabah",
      ],
  ...
  team: {
    fr: {
      ...
      losing: [
        ...
        "Alertes instantanées — dès notre synchronisation (toutes les heures)",
        "Alertes de tendance prédictive",
        "Rapports PDF pour toutes les régions mondiales",
        "Intégration Slack / Teams",
        "Chiffres exacts de cas et de décès",
        "Export CSV (données courantes et historique) + facture institutionnelle unique",
      ],
    ...
    en: {
      ...
      losing: [
        ...
        "Instant alerts — the moment our hourly sync detects something new",
        "Predictive trend alerts",
        "PDF reports for all global regions",
        "Slack / Teams integration",
        "Exact case and death figures",
        "CSV export (current data and history) + single institutional invoice",
      ],
    ...
    es: {
      ...
      losing: [
        ...
        "Alertas instantáneas — en cada sincronización (cada hora)",
        "Alertas de tendencia predictiva",
        "Informes PDF para todas las regiones",
        "Integración Slack / Teams",
        "Cifras exactas de casos y fallecidos",
        "Exportación CSV (datos actuales e historial) + factura institucional única",
      ],
    ...
    ar: {
      ...
      losing: [
        "5 مقاعد Pro لمؤسستك",
        "التنبيهات الفورية — مع كل مزامنة (كل ساعة)",
        "تنبيهات الاتجاه التنبؤية",
        "تقارير PDF لجميع المناطق العالمية",
        "تكامل Slack / Teams",
        "الأرقام الدقيقة للحالات والوفيات",
        "تصدير CSV (البيانات الحالية والسجل الكامل) + فاتورة مؤسسية واحدة",
      ],
    ...
    id: {
      ...
      losing: [
        ...
        "Peringatan instan — pada setiap sinkronisasi tiap jam",
        "Peringatan tren prediktif",
        "Laporan PDF untuk semua wilayah global",
        "Integrasi Slack / Teams",
        "Angka kasus dan kematian yang tepat",
        "Ekspor CSV (data terkini dan riwayat) + satu faktur institusional",
      ],
  ...
  enterprise: {
    fr: {
      ...
      comeback:  "Si votre équipe a encore besoin de l'API ou de nos données mises à jour toutes les heures, contactez-nous — nous pouvons trouver une solution adaptée.",
    ...
    en: {
      ...
      comeback:  "If your team still needs the API or our data updated every hour, reach out — we can find a solution that works.",
      ctaLabel:  "Talk to us →",
    ...
    es: {
      ...
      comeback:  "Si su equipo todavía necesita la API o nuestros datos actualizados cada hora, contáctenos — podemos encontrar una solución.",
    ...
    ar: {
      ...
      comeback:  "إذا كان فريقك لا يزال بحاجة إلى API أو بياناتنا المحدّثة كل ساعة، تواصل معنا — يمكننا إيجاد حل مناسب.",
    ...
    id: {
      ...
      comeback:  "Jika tim Anda masih membutuhkan API atau data kami yang diperbarui setiap jam, hubungi kami — kami dapat menemukan solusi yang tepat.",
