...
const COPY: Record<string, Record<string, ChurnCopy>> = {
  ...
  enterprise: {
    ...
    es: {
      ...
      comeback:  "Si su equipo todavía necesita la API o nuestros datos actualizados cada 6h, contáctenos — podemos encontrar una solución.",
    ...
    id: {
      ...
      comeback:  "Jika tim Anda masih membutuhkan API atau data kami yang diperbarui setiap 6 jam, hubungi kami — kami dapat menemukan solusi yang tepat.",
