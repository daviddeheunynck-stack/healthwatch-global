...
const COPY: Record<string, Record<string, ChurnCopy>> = {
  ...
  enterprise: {
    fr: {
      ...
      comeback:  "Si votre équipe a encore besoin de l'API ou des données en temps réel, contactez-nous — nous pouvons trouver une solution adaptée.",
    ...
    en: {
      ...
      comeback:  "If your team still needs the API or real-time data, reach out — we can find a solution that works.",
      ctaLabel:  "Talk to us →",
    ...
    es: {
      ...
      comeback:  "Si su equipo todavía necesita la API o datos en tiempo real, contáctenos — podemos encontrar una solución.",
    ...
    ar: {
      ...
      comeback:  "إذا كان فريقك لا يزال بحاجة إلى API أو البيانات الفورية، تواصل معنا — يمكننا إيجاد حل مناسب.",
    ...
    id: {
      ...
      comeback:  "Jika tim Anda masih membutuhkan API atau data real-time, hubungi kami — kami dapat menemukan solusi yang tepat.",
