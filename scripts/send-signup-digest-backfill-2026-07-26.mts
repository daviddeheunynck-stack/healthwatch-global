// One-off: backfill the signup digest (app/api/activate-trial/route.ts) for the
// 5 real trial users who signed up before the feature existed. Same logic as
// the route's digest block, applied against their *current* backlog (active
// qualifying outbreaks never present in their outbreak_alert_log) instead of
// their full qualifying set, so outbreaks already alerted for real aren't
// duplicated. Authorized by David in chat 2026-07-26.
...
const USERS = [
  { id: "617f58cb-0079-4ad8-82eb-0adc9489cadb", email: "guyanoel22@gmail.com" },
  { id: "60ae83a5-43ba-4f84-b377-a50a810de764", email: "zrhyacinthe2@gmail.com" },
  { id: "f31b3755-905c-45dd-b207-7277930ea219", email: "davmulambamangole@gmail.com" },
  { id: "365b23b5-0b5e-4086-bd8e-66a428900c94", email: "paulabankunda@gmail.com" },
  { id: "00c21d9f-0f09-4be6-8fea-fa51666ef513", email: "monicaevelynkamau@gmail.com" },
];
