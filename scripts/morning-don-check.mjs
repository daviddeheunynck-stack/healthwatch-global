...
const FROZEN_ROW_CHECKED = {
  // Crimée-Congo/Ouganda : vérifié le 07/09, rien de nouveau. La ligne (3 cas / 1 décès, deux
  // clusters non liés : Kyankwanzi en février, Yumbe début août) reste la meilleure lecture
  // disponible. WebSearch « CCHF Uganda cases September 2026 » et « Yumbe update » : aucune
  // publication postérieure au 08/08, rien du ministère ougandais ni d'AFRO depuis. ⚠️ Cette
  // ligne était datée dans MANUAL_ROW_CHECKED mais ABSENTE d'ici, donc la section 4d la sortait
  // « À VÉRIFIER » (9 j) pendant que la section 5 la voyait à jour (1 j) — les deux maps doivent
  // porter la ligne, elle est suivie par les deux filets. Corrigé le 07/09.
  "120d6d5a-4e9b-4fda-8a1a-67e504246c55": "2026-09-07",
