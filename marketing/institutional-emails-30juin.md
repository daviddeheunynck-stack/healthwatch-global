# Emails institutionnels — Vague 2 — 30 juin 2026

**À envoyer le lundi 30 juin** — 5 jours après le lancement PH.  
**Hook PH :** insérer `[X votes]` et `[Y signups]` depuis le dashboard PH.  
**Recherche LinkedIn :** trouver les prénoms avant envoi (30 min le matin).
...
- IRC : "International Rescue Committee" + "epidemiologist" ou "health officer" + "emergency"
- PIH : "Partners in Health" + "epidemiologist" ou "research coordinator" + "global"
- ACF : "Action Contre la Faim" + "épidémiologiste" ou "coordinateur médical"
- IMC : "International Medical Corps" + "epidemiologist" + "global"
- JHU : "Johns Hopkins Bloomberg School" + "epidemiology" + "outbreak" ou "infectious disease"
- Harvard : "Harvard Chan" + "epidemiology" + "global health" ou "infectious disease"
- INSP : "Instituto Nacional de Salud Pública" + "epidemiología" + investigador
- IRD : "IRD" ou "Institut de Recherche pour le Développement" + "épidémiologie" + MIVEGEC ou Dakar

---

## Email 1 — MSF / Epicentre

**À :** [email LinkedIn] ou `epicentre@epicentre.msf.org`
**Objet :** HealthWatch Global just launched — consolidating WHO DON, ECDC, PAHO, Africa CDC for field teams
...
Direct link to current Mpox and Ebola signals in DRC/Central Africa:
...
## Email 2 — IRC (International Rescue Committee)

**À :** [email LinkedIn]
**Objet :** HealthWatch Global just launched — outbreak surveillance consolidated for emergency health teams
...
Direct link to current surveillance in your active zones:
...
## Email 3 — PIH (Partners in Health)

**À :** [email LinkedIn]
**Objet :** HealthWatch Global just launched — WHO + ECDC + PAHO + Africa CDC in one dashboard
...
## Email 4 — ACF (Action Contre la Faim)

**À :** [email LinkedIn]
**Objet :** HealthWatch Global vient de lancer — surveillance épidémique consolidée pour les équipes terrain
...
Lien direct vers la surveillance Choléra et Dengue dans vos zones d'intervention :
...
## Email 5 — IMC (International Medical Corps)

**À :** [email LinkedIn] ou `jobs@internationalmedicalcorps.org`
**Objet :** HealthWatch Global just launched — IHR-classified outbreak monitoring for emergency health teams
...
## Email 6 — JHU Bloomberg School of Public Health

**À :** [first.last@jhu.edu — nom trouvé sur LinkedIn]
**Objet :** HealthWatch Global just launched — WHO DON + ECDC + PAHO + Africa CDC aggregated in real time
...
## Email 7 — Harvard T.H. Chan School of Public Health

**À :** [first.last@hsph.harvard.edu — nom trouvé sur LinkedIn]
**Objet :** HealthWatch Global just launched — aggregated WHO + ECDC + PAHO outbreak data
...
Direct link to current Dengue and Cholera data:
...
## Email 8 — INSP (Instituto Nacional de Salud Pública — Mexique)

**À :** [first.last@insp.mx — nom trouvé sur LinkedIn]
**Objet :** HealthWatch Global acaba de lanzar — WHO DON + ECDC + PAHO + Africa CDC en un solo dashboard
...
## Email 9 — IRD (Institut de Recherche pour le Développement)

**À :** [first.last@ird.fr — nom trouvé sur LinkedIn, unités MIVEGEC, MERIT, ou antenne Dakar]
**Objet :** HealthWatch Global vient de lancer — données OMS + ECDC + PAHO agrégées en temps réel
...
|---|---|---|
| `[X] votes` | Dashboard PH | J+5 = 30 juin matin |
| `[Y] signups` | Supabase dashboard | 30 juin matin |
| `[First name]` (×9) | LinkedIn — 30 min de recherche | 30 juin matin |
| `[specific research area]` (×4) | Profil LinkedIn du contact | 30 juin matin |
...
- **FR :** "Bonjour [Prénom], je reviens sur mon message du 30 juin — je peux activer l'accès pilote quand vous souhaitez."
- **ES :** "Hola [Nombre], solo hago seguimiento a mi mensaje del 30 de junio — puedo activar el acceso piloto cuando lo desee."
