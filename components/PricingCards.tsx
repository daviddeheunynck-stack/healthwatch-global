...
const COPY: Record<string, {
  ...
  fr: {
    ...
    freeBadge: "Gratuit",
    starterFeatures: ["Carte mondiale interactive", "1 région surveillée", "Données OMS (sync daily)", "Digest hebdomadaire gratuit", "Tableau de bord multilingue"],
  ...
  en: {
    ...
    freeBadge: "Free",
    starterFeatures: ["Interactive world map", "1 monitored region", "WHO data (daily sync)", "Free weekly digest", "Multilingual dashboard"],
  ...
  es: {
    ...
    freeBadge: "Gratis",
    starterFeatures: ["Mapa mundial interactivo", "1 región monitoreada", "Datos OMS (sync daily)", "Digest semanal gratuito", "Panel multilingüe"],
