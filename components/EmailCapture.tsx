...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    trialNote: "14 days free · Card required, no charge until trial ends",
  ...
  fr: {
    ...
    trialNote: "14 jours gratuits · Carte requise, aucun débit avant la fin de l'essai",
  ...
  es: {
    ...
    trialNote: "14 días gratis · Tarjeta requerida, sin cobro hasta que termine la prueba",
  ...
  ar: {
    ...
    trialNote: "14 يوماً مجاناً · البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    trialNote: "14 hari gratis · Kartu diperlukan, tidak ada tagihan sebelum uji coba berakhir",
