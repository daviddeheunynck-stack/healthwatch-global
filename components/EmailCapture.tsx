...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    proSub: "Region filtering · Regional alerts · PDF reports · CSV export",
    proBtn: "Start free trial →",
    trialNote: "7 days free · Card required, no charge until trial ends",
  ...
  fr: {
    ...
    proSub: "Filtre par région · Alertes régionales · Rapports PDF · Export CSV",
    proBtn: "Commencer l'essai gratuit →",
    trialNote: "7 jours gratuits · Carte requise, aucun débit avant la fin de l'essai",
  ...
  es: {
    ...
    proSub: "Filtro por región · Alertas regionales · Informes PDF · Exportación CSV",
    proBtn: "Iniciar prueba gratuita →",
    trialNote: "7 días gratis · Tarjeta requerida, sin cobro hasta que termine la prueba",
  ...
  ar: {
    ...
    proSub: "التصفية حسب المنطقة · تنبيهات إقليمية · تقارير PDF · تصدير CSV",
    proBtn: "← ابدأ التجربة المجانية",
    trialNote: "7 أيام مجاناً · البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    proSub: "Filter wilayah · Peringatan regional · Laporan PDF · Ekspor CSV",
    proBtn: "Mulai uji coba gratis →",
    trialNote: "7 hari gratis · Kartu diperlukan, tidak ada tagihan sebelum uji coba berakhir",
