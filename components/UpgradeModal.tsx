...
const COPY: Record<string, {
  ...
  fr: {
    pdf:      { title: "Rapports PDF régionaux",      desc: "Téléchargez des rapports épidémiologiques prêts à partager avec vos équipes ou bailleurs.",   plan: "Disponible — Starter & Pro" },
    ...
    list:     { title: "Liste complète des foyers",   desc: "Accédez à tous les foyers actifs par région avec chiffres exacts.",                            plan: "Disponible — Starter & Pro" },
    cases:    { title: "Chiffres confirmés",          desc: "Cas confirmés, décès et détails épidémiologiques complets pour chaque foyer.",                 plan: "Disponible — Starter & Pro" },
    csv:      { title: "Export CSV des données",      desc: "Téléchargez l'ensemble des foyers actifs en CSV pour Excel, R, Python ou vos outils internes.", plan: "Disponible — Starter & Pro" },
    proFeatures: [
      "Alertes temps réel — flux OMS direct",
      "Rapports PDF par région en 1 clic",
      "Export CSV pour vos analyses internes",
      "3 régions (Starter) · Toutes régions (Pro)",
    ],
    cta:   "Voir les offres",
    trial: "Essai Pro 14 jours · Sans carte bancaire",
  },
  en: {
    pdf:      { title: "Regional PDF reports",     desc: "Download shareable epidemiological reports ready for your teams or donors.",             plan: "Available — Starter & Pro" },
    ...
    list:     { title: "Full outbreak list",       desc: "Access all active outbreaks per region with exact case and death figures.",              plan: "Available — Starter & Pro" },
    cases:    { title: "Confirmed figures",        desc: "Confirmed cases, deaths and full epidemiological details for every outbreak.",           plan: "Available — Starter & Pro" },
    csv:      { title: "CSV data export",          desc: "Download all active outbreaks as CSV for Excel, R, Python or your internal tools.",      plan: "Available — Starter & Pro" },
    proFeatures: [
      "Real-time alerts — direct WHO feed",
      "Regional PDF reports in 1 click",
      "CSV export for your internal analyses",
      "3 regions (Starter) · All regions (Pro)",
    ],
    cta:   "See plans",
    trial: "14-day Pro trial · No credit card",
  },
  es: {
    pdf:      { title: "Informes PDF regionales",     desc: "Descargue informes epidemiológicos listos para compartir con su equipo o financiadores.",    plan: "Disponible — Starter y Pro" },
    ...
    list:     { title: "Lista completa de brotes",    desc: "Acceda a todos los brotes activos por región con cifras exactas.",                           plan: "Disponible — Starter y Pro" },
    cases:    { title: "Cifras confirmadas",          desc: "Casos confirmados, fallecidos y detalles epidemiológicos completos.",                         plan: "Disponible — Starter y Pro" },
    csv:      { title: "Exportación de datos CSV",    desc: "Descargue todos los brotes activos en CSV para Excel, R, Python o sus herramientas internas.", plan: "Disponible — Starter y Pro" },
    proFeatures: [
      "Alertas en tiempo real — flujo OMS directo",
      "Informes PDF regionales en 1 clic",
      "Exportación CSV para análisis internos",
      "3 regiones (Starter) · Todas las regiones (Pro)",
    ],
    cta:   "Ver planes",
    trial: "Prueba Pro 14 días · Sin tarjeta",
  },
  ar: {
    pdf:      { title: "تقارير PDF إقليمية",           desc: "حمّل تقارير وبائية جاهزة للمشاركة مع فرقك أو المموّلين بنقرة واحدة.",            plan: "متاح — Starter وPro" },
    realtime: { title: "تنبيهات فورية",                desc: "استقبل كل تفشٍّ جديد من منظمة الصحة العالمية في ثوانٍ، قبل الجميع.",             plan: "متاح — Pro فقط" },
    list:     { title: "قائمة كاملة بالتفشيات",        desc: "اطلع على جميع التفشيات النشطة بالمنطقة مع الأرقام الدقيقة.",                   plan: "متاح — Starter وPro" },
    cases:    { title: "الأرقام المؤكدة",              desc: "الحالات المؤكدة والوفيات والتفاصيل الوبائية الكاملة لكل تفشٍّ.",                plan: "متاح — Starter وPro" },
    csv:      { title: "تصدير بيانات CSV",             desc: "حمّل جميع التفشيات النشطة بصيغة CSV لـ Excel أو R أو Python أو أدواتك الداخلية.", plan: "متاح — Starter وPro" },
    proFeatures: [
      "تنبيهات فورية — بث مباشر من المنظمة",
      "تقارير PDF إقليمية بنقرة واحدة",
      "تصدير CSV للتحليلات الداخلية",
      "3 مناطق (Starter) · جميع المناطق (Pro)",
    ],
    cta:   "عرض الخطط",
    trial: "تجربة Pro 14 يوماً · بدون بطاقة بنكية",
  },
  id: {
    pdf:      { title: "Laporan PDF regional",        desc: "Unduh laporan epidemiologi siap dibagikan ke tim atau donor Anda.",                      plan: "Tersedia — Starter & Pro" },
    ...
    list:     { title: "Daftar wabah lengkap",        desc: "Akses semua wabah aktif per wilayah dengan angka kasus dan kematian yang tepat.",        plan: "Tersedia — Starter & Pro" },
    cases:    { title: "Angka terkonfirmasi",         desc: "Kasus terkonfirmasi, kematian, dan detail epidemiologi lengkap setiap wabah.",           plan: "Tersedia — Starter & Pro" },
    csv:      { title: "Ekspor data CSV",             desc: "Unduh semua wabah aktif sebagai CSV untuk Excel, R, Python, atau alat internal Anda.",   plan: "Tersedia — Starter & Pro" },
    proFeatures: [
      "Peringatan real-time — feed WHO langsung",
      "Laporan PDF regional dalam 1 klik",
      "Ekspor CSV untuk analisis internal",
      "3 wilayah (Starter) · Semua wilayah (Pro)",
    ],
    cta:   "Lihat paket",
