...
const COPY: Record<string, {
  ...
  fr: {
    ...
    proFeatures: [
      ...
      "Alertes prédictives — prévenu avant qu'un seuil soit franchi, pas après",
    ...
    trial:       "7 jours gratuits · Carte requise, aucun débit avant la fin de l'essai",
  ...
  en: {
    ...
    proFeatures: [
      ...
      "Predictive alerts — warned before a threshold is crossed, not after",
    ...
    trial:       "7 days free · Card required, no charge until trial ends",
  ...
  es: {
    ...
    proFeatures: [
      ...
      "Alertas predictivas — avisado antes de superar un umbral, no después",
    ...
    trial:       "7 días gratis · Tarjeta requerida, sin cobro hasta que termine la prueba",
  ...
  ar: {
    ...
    proFeatures: [
      ...
      "تنبيهات تنبؤية — إشعار قبل تجاوز العتبة، لا بعده",
    ...
    trial:       "7 أيام مجاناً · البطاقة مطلوبة، لا خصم قبل انتهاء التجربة",
  ...
  id: {
    ...
    proFeatures: [
      ...
      "Peringatan prediktif — diperingatkan sebelum ambang batas terlampaui, bukan sesudahnya",
    ...
    trial:       "7 hari gratis · Kartu diperlukan, tidak ada tagihan sebelum uji coba berakhir",
