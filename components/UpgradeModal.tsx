...
const COPY: Record<string, {
  ...
  en: {
    ...
    trial:       "14 days free · Card required, no charge until trial ends",
  ...
  es: {
    ...
    trial:       "14 días gratis · Tarjeta requerida, sin cobro hasta que termine la prueba",
  ...
  id: {
    ...
    trial:       "14 hari gratis · Kartu diperlukan, tidak ada tagihan sebelum uji coba berakhir",
