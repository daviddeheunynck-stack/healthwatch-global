...
const COPY: Record<string, {
  ...
  fr: {
    ...
    comparisonFeatures: ["4 sources unifiées : OMS + ECDC + OPAS + Africa CDC", "Scoring RSI automatique (Art. 6, 9, 12)", "5 langues (FR, EN, ES, AR, ID)", "Alertes email par maladie / région", "CFR & incidence calculés automatiquement", "Watchlist & notifications"],
  ...
  en: {
    ...
    comparisonTitle: "HealthWatch vs who.int",
    comparisonFeatures: ["4 official sources unified: WHO + ECDC + PAHO + Africa CDC", "Automated IHR risk scoring (Art. 6, 9, 12)", "5 languages (FR, EN, ES, AR, ID)", "Email alerts by disease / region", "CFR & incidence auto-calculated", "Watchlist & notifications"],
  ...
  es: {
    ...
    comparisonTitle: "HealthWatch vs who.int",
    comparisonFeatures: ["4 fuentes unificadas: OMS + ECDC + PAHO + Africa CDC", "Scoring RSI automatizado (Art. 6, 9, 12)", "5 idiomas (FR, EN, ES, AR, ID)", "Alertas email por enfermedad / región", "CFR & incidencia calculados automáticamente", "Lista de seguimiento & notificaciones"],
  ...
  ar: {
    ...
    comparisonFeatures: ["4 مصادر موحّدة: WHO + ECDC + PAHO + Africa CDC", "تقييم IHR تلقائي (المادة 6، 9، 12)", "5 لغات (FR, EN, ES, AR, ID)", "تنبيهات البريد الإلكتروني حسب المرض / المنطقة", "CFR والإصابة محسوبان تلقائياً", "قائمة المراقبة والإشعارات"],
  ...
  id: {
    ...
    comparisonTitle: "HealthWatch vs who.int",
    comparisonFeatures: ["4 sumber resmi terintegrasi: WHO + ECDC + PAHO + Africa CDC", "Penilaian IHR otomatis (Pasal 6, 9, 12)", "5 bahasa (FR, EN, ES, AR, ID)", "Peringatan email per penyakit / wilayah", "CFR & insidensi dihitung otomatis", "Daftar pantau & notifikasi"],
