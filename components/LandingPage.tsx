...
const COPY: Record<string, {
  ...
  en: {
    ...
    pricingFree: "Free",
    pricingStarter: "$199 /month",
    pricingPro: "$590 /month",
  ...
  id: {
    ...
    pricingFree: "Gratis",
    pricingStarter: "Rp 3.200.000 /bulan",
    pricingPro: "Rp 9.500.000 /bulan",
