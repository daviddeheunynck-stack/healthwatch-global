...
const COPY: Record<string, {
  ...
  fr: {
    ...
    heroNoCc: "Gratuit · 7 jours Pro offerts · Sans carte bancaire",
    ...
    steps: [
      ...
      { title: "Passez Pro pour les alertes instantanées", desc: "Vos 7 premiers jours Pro sont offerts — flux en direct, rapports PDF, export CSV et alertes par maladie déjà actifs." },
    ],
    ...
    pricingProCta: "Essai Pro gratuit 7 jours →",
    ...
    ctaNoCc: "7 jours Pro offerts · Sans carte bancaire · Accès immédiat",
  ...
  en: {
    ...
    heroNoCc: "Free · 7-day Pro trial · No credit card required",
    ...
    steps: [
      ...
      { title: "Go Pro for instant alerts", desc: "Your first 7 days are free — live feed, PDF reports, CSV export, and disease alerts already active." },
    ],
    ...
    ctaNoCc: "7-day Pro trial · No credit card · Instant access",
  ...
  es: {
    ...
    heroNoCc: "Gratis · 7 días Pro de prueba · Sin tarjeta de crédito",
    ...
    steps: [
      ...
      { title: "Pase a Pro para alertas instantáneas", desc: "Sus primeros 7 días Pro están incluidos — flujo en vivo, informes PDF, exportación CSV y alertas por enfermedad ya activos." },
    ],
    ...
    ctaNoCc: "7 días Pro incluidos · Sin tarjeta · Acceso inmediato",
  ...
  ar: {
    ...
    heroNoCc: "مجاني · 7 أيام Pro مجاناً · لا بطاقة بنكية مطلوبة",
    ...
    steps: [
      ...
      { title: "انتقل إلى Pro للتنبيهات الفورية", desc: "أول 7 أيام Pro مجانية — البث المباشر وتقارير PDF وتصدير CSV وتنبيهات المرض نشطة فوراً." },
    ],
    ...
    ctaNoCc: "7 أيام Pro مجاناً · بدون بطاقة بنكية · وصول فوري",
  ...
  id: {
    ...
    heroNoCc: "Gratis · 7 hari Pro gratis · Tanpa kartu kredit",
    ...
    steps: [
      ...
      { title: "Upgrade ke Pro untuk peringatan instan", desc: "7 hari pertama Pro sudah termasuk — umpan langsung, laporan PDF, ekspor CSV, dan peringatan per penyakit langsung aktif." },
    ],
    ...
    ctaNoCc: "7 hari Pro gratis · Tanpa kartu kredit · Akses langsung",
