...
const COPY: Record<string, {
  ...
  fr: {
    ...
    features: [
      { title: "Alertes par maladie", desc: "Abonnez-vous à H5N1, Ebola, Mpox… Recevez un email dans les 8h dès qu'un foyer est signalé par l'OMS n'importe où dans le monde." },
    ...
    orgs: ["Médecins de médecine des voyages", "Consultants santé indépendants", "Journalistes & analystes", "Épidémiologistes & chercheurs"],
    ...
    ctaSub: "HealthWatch Global agrège les bulletins officiels OMS, les données ECDC et les agences nationales pour que les professionnels de santé aient tout en un seul endroit — sans passer des heures sur who.int.",
    ctaButton: "Démarrer gratuitement",
    ctaNoCc: "Sans carte bancaire · Accès immédiat",
    trustTitle: "Sources officielles OMS · 195 pays · 5 langues",
    trustSub: "HealthWatch Global agrège les sources que vous consultez déjà — directement, sans intermédiaire, dans votre langue.",
  ...
  en: {
    ...
    features: [
      { title: "Disease-specific alerts", desc: "Subscribe to H5N1, Ebola, Mpox… Get an email within 8 hours of any WHO-reported outbreak, anywhere in the world." },
    ...
    orgs: ["Travel medicine doctors", "Independent health consultants", "Health journalists & analysts", "Epidemiologists & researchers"],
    ...
    ctaSub: "HealthWatch Global aggregates official WHO bulletins, ECDC data and national health agencies so health professionals have everything in one place — without the manual research.",
    ctaButton: "Get started free",
    ctaNoCc: "No credit card · Instant access",
    trustTitle: "Official WHO data · 195 countries · 5 languages",
    trustSub: "HealthWatch Global aggregates the sources you already consult — directly, with no intermediary, in your language.",
  ...
  es: {
    ...
    features: [
      { title: "Alertas por enfermedad", desc: "Suscríbase a H5N1, Ébola, Mpox… Reciba un email en menos de 8h cuando la OMS reporte un brote en cualquier parte del mundo." },
    ...
    orgs: ["Médicos de medicina de viaje", "Consultores de salud independientes", "Periodistas & analistas", "Epidemiólogos & investigadores"],
    ...
    ctaSub: "HealthWatch Global agrega boletines oficiales de la OMS, datos del ECDC y agencias nacionales para que los profesionales de la salud tengan todo en un solo lugar — sin investigación manual.",
    ctaButton: "Comenzar gratis",
    ctaNoCc: "Sin tarjeta de crédito · Acceso inmediato",
    trustTitle: "Datos OMS oficiales · 195 países · 5 idiomas",
    trustSub: "HealthWatch Global agrega las fuentes que ya consulta — directamente, sin intermediarios, en su idioma.",
  ...
  ar: {
    ...
    features: [
      { title: "تنبيهات الأمراض", desc: "اشترك في H5N1 أو إيبولا أو جدري القرود… واستقبل بريداً إلكترونياً في غضون 8 ساعات من إعلان منظمة الصحة العالمية عن أي تفشٍّ في العالم." },
    ...
    orgs: ["أطباء طب السفر", "مستشارو الصحة المستقلون", "الصحفيون والمحللون", "علماء الأوبئة والباحثون"],
    ...
    ctaSub: "تجمع HealthWatch Global نشرات منظمة الصحة العالمية الرسمية وبيانات ECDC والوكالات الوطنية ليجد المتخصصون في الصحة كل شيء في مكان واحد — دون بحث يدوي.",
    ctaButton: "ابدأ مجاناً",
    ctaNoCc: "بدون بطاقة بنكية · وصول فوري",
    trustTitle: "بيانات WHO رسمية · 195 دولة · 5 لغات",
    trustSub: "تجمع HealthWatch Global المصادر التي تراجعها بالفعل — مباشرةً، دون وسطاء، بلغتك.",
  ...
  id: {
    ...
    features: [
      { title: "Peringatan per penyakit", desc: "Berlangganan H5N1, Ebola, Mpox… Terima email dalam 8 jam setelah WHO melaporkan wabah di mana saja di dunia." },
    ...
    orgs: ["Dokter kedokteran perjalanan", "Konsultan kesehatan independen", "Jurnalis & analis kesehatan", "Epidemiolog & peneliti"],
    ...
    ctaSub: "HealthWatch Global mengumpulkan buletin resmi WHO, data ECDC, dan lembaga nasional sehingga tenaga kesehatan memiliki segalanya di satu tempat — tanpa penelitian manual.",
    ctaButton: "Mulai gratis",
    ctaNoCc: "Tanpa kartu kredit · Akses langsung",
    trustTitle: "Data WHO resmi · 195 negara · 5 bahasa",
    trustSub: "HealthWatch Global mengagregasi sumber yang sudah Anda konsultasikan — langsung, tanpa perantara, dalam bahasa Anda.",
