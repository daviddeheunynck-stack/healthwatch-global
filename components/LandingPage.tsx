...
const COPY: Record<string, {
  ...
  fr: {
    ...
    orgs: ["Épidémiologistes & chercheurs", "Risque corporate & mobilité internationale", "Médecins de médecine des voyages", "Journalistes & analystes santé"],
  ...
  en: {
    ...
    orgs: ["Epidemiologists & researchers", "Corporate risk & global mobility", "Travel medicine doctors", "Health journalists & analysts"],
  ...
  es: {
    ...
    orgs: ["Epidemiólogos & investigadores", "Riesgo corporativo & movilidad global", "Médicos de medicina de viaje", "Periodistas & analistas"],
  ...
  ar: {
    ...
    orgs: ["علماء الأوبئة والباحثون", "إدارة المخاطر والتنقل الدولي", "أطباء طب السفر", "الصحفيون والمحللون"],
  ...
  id: {
    ...
    orgs: ["Epidemiolog & peneliti", "Manajemen risiko & mobilitas global", "Dokter kedokteran perjalanan", "Jurnalis & analis kesehatan"],
