...
const COPY: Record<string, {
  ...
  en: {
    ...
    f1: "WHO-sourced alerts, updated daily",
  ...
  fr: {
    ...
    f1: "Alertes OMS, mises à jour quotidiennement",
  ...
  es: {
    ...
    f1: "Alertas OMS, actualizadas diariamente",
  ...
  ar: {
    ...
    f1: "تنبيهات منظمة الصحة العالمية، تُحدَّث يومياً",
  ...
  id: {
    ...
    f1: "Peringatan WHO, diperbarui setiap hari",
