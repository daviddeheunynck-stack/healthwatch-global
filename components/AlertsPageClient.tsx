...
const LABELS: Record<string, {
  ...
  fr: {
    ...
    proUpsellCta: "Commencer l'essai gratuit 7 jours",
  ...
  en: {
    ...
    proUpsellCta: "Start 7-day free trial",
  ...
  es: {
    ...
    proUpsellCta: "Iniciar prueba gratuita de 7 días",
  ...
  ar: {
    ...
    proUpsellCta: "← ابدأ التجربة المجانية 7 أيام",
  ...
  id: {
    ...
    proUpsellCta: "Mulai uji coba gratis 7 hari",
